...
class BookingScreen extends StatefulWidget {
  final m.User doctor;
  final m.User patient;

  const BookingScreen({Key? key, required this.doctor, required this.patient}) : super(key: key);
  @override
...
class _BookingScreenState extends State<BookingScreen> {
  ...
  showAlertDialog(BuildContext context) {
    ...
    Widget okButton = TextButton(
      ...
      onPressed: () {
        context.read<PageBloc>().add(GoToMyAppointments());
      },
    );
  ...
  void initState() {
    ...
    _getUser();
    selectTime(context);
    _doctorController.text = widget.doctor.fullName!;
  }
